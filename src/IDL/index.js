export const carrotFactory = ({ IDL }) => {
...
export const daoFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    addControlledCanister: IDL.Func([IDL.Nat, CanisterInfo], [IDL.Bool], []),
    addQuestion: IDL.Func([IDL.Nat, QuestionInfo], [IDL.Bool], []),
    addVotes: IDL.Func([IDL.Nat, VoterInfo, IDL.Text, IDL.Nat], [IDL.Bool], []),
    availableCycles: IDL.Func([], [IDL.Nat], ["query"]),
    ...
    getCanisterQuestionCount: IDL.Func(
      [IDL.Principal],
      [IDL.Nat],
      ['query'],
    ),
    ...
    getControlledCanisters: IDL.Func(
      [],
      [IDL.Vec(IDL.Tuple(IDL.Nat, CanisterInfo))],
      ["query"]
    ),
    ...
    removeControlledCanister: IDL.Func([IDL.Nat, IDL.Nat], [IDL.Bool], []),
    resetAnswer: IDL.Func([IDL.Nat], [IDL.Bool], []),
    wallet_receive: IDL.Func([], [IDL.Record({ accepted: IDL.Nat64 })], []),
  });
};

// Comnmon for all token eg(Boxy dude, NFT etc...)
export const tokensFactory = ({ IDL }) => {
...
export const cyclesFactory = ({ IDL }) => {
  // const CanisterInfo = IDL.Record({
  //   'canisterName' : IDL.Text,
  //   'canister' : IDL.Principal,
  // });
