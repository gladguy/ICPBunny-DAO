export const liquidifyIdlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        'getLenderByOfferID': IDL.Func([IDL.Nat], [IDL.Principal], []),
        'getLoanAmount': IDL.Func(
            [IDL.Opt(IDL.Vec(CollectionOffers)), IDL.Nat],
            [IDL.Opt(IDL.Nat)],
            [],
        ),
        ...
        'isLoanOfferActive': IDL.Func([IDL.Nat], [IDL.Bool], ['query']),
